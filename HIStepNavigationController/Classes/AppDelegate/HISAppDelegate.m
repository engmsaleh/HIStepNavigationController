...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  HISFirstStepViewController *rootVC = [storyboard instantiateViewControllerWithIdentifier:@"FirstStepView"];
  HISteppingNavigationController *navController = [[HISteppingNavigationController alloc] initWithRootViewController:rootVC];
